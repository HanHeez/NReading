package com.gtv.hanhee.bookflip.bookflip;
...
import com.gtv.hanhee.bookflip.R;
import com.gtv.hanhee.bookflip.utils.AphidLog;
...
public class FlipViewController extends AdapterView<Adapter> {
    ...
    public void setAdapter(Adapter adapter, int initialPosition) {
        ...
        junit.framework.Assert.assertNotNull("adapter should not be null", adapter);
    ...
    private void releaseView(View view) {
        junit.framework.Assert.assertNotNull(view);
    ...
    private View viewFromAdapter(int position, boolean addToTop) {
        junit.framework.Assert.assertNotNull(adapter);
    ...
    void flippedToView(final int indexInAdapter, boolean isPost) {
        ...
        if (indexInAdapter >= 0 && indexInAdapter < adapterDataCount) {
            ...
            junit.framework.Assert.fail("Invalid indexInAdapter: " + indexInAdapter);
        }
        //debugBufferedViews();
    }
