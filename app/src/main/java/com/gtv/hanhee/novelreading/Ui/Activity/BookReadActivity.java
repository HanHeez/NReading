...
//    private BookMarkAdapter mMarkAdapter;
    ...
    //hêm nhu cầu bộ sưu tập, vì vậy hãy vượt qua toàn bộ lớp thực thể khi nhảy
...
//        recommendBooks = (Recommend.RecommendBooks) getIntent().getSerializableExtra(INTENT_BEAN);
        ...
        mRlBookReadRoot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rlReadAaSet.setVisibility(View.VISIBLE);
                rlReadMark.setVisibility(View.VISIBLE);
            }
        });
